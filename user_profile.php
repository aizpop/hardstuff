<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Update database
        $sql = "UPDATE users SET fname='$fname', lname='$lname', dob='$dob', gender='$gender', address='$address', pnumber='$pnumber', usertype='$usertype', profile_picture='$profile_picture' WHERE id='$id'";
