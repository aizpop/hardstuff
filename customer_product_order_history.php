    ...
    <section class="home-section">
        <header>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                <a href="customer_product_order_history.php" class="nav-link active" style="padding-left: 50px;padding-right: 50px;">
                    <i class="fa-sharp fa-solid fa-house fa-sm" style="color: #000000;" class="active">&nbsp&nbsp</i>Product</a>
                </li>
                <li class="nav-item">
                  <a href="customer_service_order_history.php" class="nav-link active" style="padding-left: 50px;padding-right: 50px;">
